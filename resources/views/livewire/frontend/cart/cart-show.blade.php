            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="shopping-cart">
                                ...
                                <div class="col-md-6 my-auto">
                                    <a
                                        ...
                                        <label class="product-name">
                                            ...
                                            - <span class="badge bg-success">Color : {{
                                ...
                                <div class="col-md-2 col-7 my-auto">
                                    <div class="quantity">
                                        <div class="input-group">
                                            <button type="button" wire:click="decrementQty({{ $cartItem->id }})"
                                                class="btn btn1"><i class="fa fa-minus"></i></button>
                                            <input type="text" value="{{ $cartItem->quantity }}"
                                                class="input-quantity" />
                                            <button type="button" wire:loading.attr="disabled"
                                                wire:click="incrementQty({{ $cartItem->id }})" class="btn btn1"><i
                        ...
                        @endif
                        @empty
                        <h4 class="text-center bg-white p-4">No Cart Items available</h4>
                        @endforelse
