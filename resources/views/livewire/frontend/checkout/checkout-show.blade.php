    ...
    <div class="py-3 py-md-4 checkout">
        <div class="container">
            ...
            <div class="card card-body shadow text-center p-md-5">
                ...
                <a href="{{ url('/collections') }}" class="btn btn-warning lg">Shop now</a>
            </div>
            @endif
...
<script
    src="https://www.paypal.com/sdk/js?client-id=AdKoQAykCXqbrHoqXnTsXPIXzkAlym3nOyZ2izIDGz-_VHEDBd1jUC7fev8Y_i_k_wHBJUqEQ5SjwqkL&currency=USD">
</script>
