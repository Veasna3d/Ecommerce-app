<div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-phone"></i> {{ $appSetting->phone1 ?? 'website name'}}
                        </a>
                    </div>
                    <div class="mb-2">
                        <a href="" class="text-white">
                            <i class="fa fa-envelope"></i> {{ $appSetting->email1 ?? 'website name'}}
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2023 - Veasna. All rights reserved.</p>
                </div>
                <div class="col-md-4">
                    <div class="social-media">
                        ...
                        <a href="{{ $appSetting->facebook}}"><i class="fa fa-twitter"></i></a>
                        @endif
                        @if ( $appSetting->instagram)
                        <a href="{{ $appSetting->facebook}}"><i class="fa fa-instagram"></i></a>
                        @endif
                        @if ( $appSetting->youtube)
                        <a href="{{ $appSetting->facebook}}"><i class="fa fa-youtube"></i></a>
                        @endif
                    </div>
                </div>
            </div>
